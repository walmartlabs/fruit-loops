  ...
  return {
    ...
    exec: function(exec, errorHandler) {
      ...
      try {
        ...
        if (err._redirect) {
          // Be a bit paranoid when dealing with error objects that might not have
          // their stack read.
          err.stack;
          return;
        }
    ...
    processError: function(err) {
      return processError.call(this, err);
    },
    rewriteStack: function(stack) {
      return rewriteStack.call(this, stack);
    }
  };
};
