...
module.exports = exports = function(options) {
  ...
  function _callback(err, data) {
    ...
    _callback(err, data, {status: status, cache: minimumCache, pageId: _id, pageCount: pageCount});
