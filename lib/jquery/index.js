...
module.exports = exports = function(window, html, pending) {
  ...
  function $(selector, context) {
    ...
    if (selector === 'html' || selector === ':root') {
      htmlEl = htmlEl || root(selector, context);
      return htmlEl;
    } else if (selector === 'body') {
      bodyEl = bodyEl || root(selector, context);
      return bodyEl;
    } else if (selector === 'head') {
      headEl = headEl || root(selector, context);
      return headEl;
    } else {
  ...
  $.grep = function(elements, callback) {
    return _.filter(elements, callback);
  };
